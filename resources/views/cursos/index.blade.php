...
@section('content_header')
    <div class="my-4">
        <h1 class="callout callout-info bg-transparent border-none shadow-none p-4 d-inline">Cursos</h1>
        @can('cursos.create')
            <a href="{{ route('cursos.create') }}" class="btn btn-success float-right">
