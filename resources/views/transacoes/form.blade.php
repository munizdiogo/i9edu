...
<div class="form-group">
    ...
    <input type="text" name="valor" class="form-control" value="{{ old('valor', $transacao->valor ?? '') }}" required>
</div>
...
<div class="form-group">
    ...
    <select name="situacao" class="form-control">
        <option value="ABERTO" {{ old('situacao', $transacao->situacao ?? '') == 'ABERTO' ? 'selected' : '' }}>ABERTO
        </option>
        <option value="PAGO" {{ old('situacao', $transacao->situacao ?? '') == 'PAGO' ? 'selected' : '' }}>PAGO</option>
...
<div class="form-group">
    ...
    <select name="status" class="form-control">
        <option value="ativo" {{ old('status', $transacao->status ?? '') == 'ativo' ? 'selected' : '' }}>Ativo</option>
        <option value="inativo" {{ old('status', $transacao->status ?? '') == 'inativo' ? 'selected' : '' }}>Inativo
        </option>
    </select>
</div>

<!-- Adicione outros campos conforme o necessário -->
