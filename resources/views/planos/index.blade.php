...
@section('content_header')
    <div class="my-4">
        <h1 class="callout callout-info bg-transparent border-none shadow-none p-4 d-inline">Planos de Pagamento</h1>

        @can('planos_pagamento.create')
            <a href="{{ route('planos_pagamento.create') }}" class="btn btn-success float-right">
                <i class="fa fa-plus"></i> Novo Plano de Pagamento
            </a>
        @endcan
    </div>
@endsection
