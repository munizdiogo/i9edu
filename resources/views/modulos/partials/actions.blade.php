<a href="{{ route('modulos.show', $m) }}" class="btn my-0 btn-primary"><i class="fas fa-eye"></i></a>
<a href="{{ route('modulos.edit', $m) }}" class="btn my-0 btn-warning"><i class="fas fa-edit"></i></a>
