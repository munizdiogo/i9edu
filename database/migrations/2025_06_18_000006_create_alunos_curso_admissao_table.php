...
class CreateAlunosCursoAdmissaoTable extends Migration
{
    public function up()
    {
        Schema::create('alunos_curso_admissao', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('id_periodo_letivo_ingresso')->nullable();
            ...
            // Process o seletivo
            $table->unsignedBigInteger('id_forma_ingresso')->nullable();
            ...
            $table->foreign('id_periodo_letivo_ingresso')->references('id')->on('periodos_letivos');
